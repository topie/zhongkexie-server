...
public class ZipUtil {
	...
	public static void zipFiles(List<File> srcfile, File zipfile) {
		...
		try {
			...
			for (int i = 0; i < srcfile.size(); i++) {
				...
				String newName = srcfile.get(i).getName();
				if(newName.lastIndexOf("_")!=0)
	...
	public static void main(String[] args) {
		// 2个源文件
		File f1 = new File(
				"D:\\workspace\\flexTest\\src\\com\\biao\\test\\abc.txt");
		File f2 = new File(
				"D:\\workspace\\flexTest\\src\\com\\biao\\test\\test.zip");
		File[] srcfile = { f1, f2 };
		// 压缩后的文件
		File zipfile = new File(
				"D:\\workspace\\flexTest\\src\\com\\biao\\test\\biao.zip");
