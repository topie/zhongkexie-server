...
public class ScorePaper extends Sortable {
	...
	@Column(name = "falsity_count")
	private Integer falsityCount;
	
	@Column(name = "falsity_count_item")
	private Integer falsityCountItem;
	...
	public Integer getFalsityCount() {
		return falsityCount;
	}

	public void setFalsityCount(Integer falsityCount) {
		this.falsityCount = falsityCount;
	}

	public Integer getFalsityCountItem() {
		return falsityCountItem;
	}

	public void setFalsityCountItem(Integer falsityCountItem) {
		this.falsityCountItem = falsityCountItem;
	}
